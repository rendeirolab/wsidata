...
from .bioformat import BioFormatsReader
...
def get_reader(reader: str = None):
    readers = {"openslide": None, "cucim": None, "tiffslide": None, "bioformats": None}
    error_stack = {
        "openslide": None,
        "cucim": None,
        "tiffslide": None,
    ...
    try:
        ...
        readers["bioformats"] = BioFormatsReader
    except catch_error as e:
        error_stack["bioformats"] = e
    ...
    reader_candidates = ["openslide", "tiffslide", "bioformats", "cucim"]
    if reader is None:
        ...
        raise ValueError(
            ...
            f"\nbioformats: {error_stack['bioformats']}"
